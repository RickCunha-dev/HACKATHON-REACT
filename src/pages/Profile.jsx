    ...
    try {
      ...
      if (savedProfileData) {
        ...
        const defaultUserData = {
          name: 'Ricardo Silva',
          bio: 'Desenvolvedor Full Stack apaixonado por tecnologia e inovação. Sempre em busca de novos desafios e oportunidades de aprendizado.',
          avatar_url: '/images/ricardo.jpeg',
          location: 'São Paulo, Brasil',
          company: 'Infinity School',
          website: 'https://ricardosilva.dev',
          jobTitle: 'Desenvolvedor Full Stack',
          education: 'Sistemas de Informação - FIAP',
          extensionCourse: 'React Avançado - Alura',
          phone: '(11) 99999-9999',
          birthDate: '1995-05-15',
          skills: ['HTML5', 'CSS3', 'JavaScript', 'React', 'Node.js', 'Python', 'Git', 'GitHub'],
          socialLinks: [
            'https://github.com/ricardosilva',
            'https://linkedin.com/in/ricardosilva',
            'https://instagram.com/ricardosilva'
          ]
        };
